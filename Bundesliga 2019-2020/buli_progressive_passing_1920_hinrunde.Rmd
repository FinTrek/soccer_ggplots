...
ggplot(buli_pass_df, 
  ...
  labs(title = "Progressive Passers: <b style='color: red'>Bundesliga</b>", 
       subtitle = glue("
                       ...
                       <p><b style='color: black'>Average (Median)</b> | Minimum 900 Minutes Played"),
       caption = glue("
