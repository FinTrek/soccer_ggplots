...
```{r}
wojciech_desc <- "as Juventus aim for a 9th consecutive Scudetto. 80% Save % the highest in the league   0.92 Goals Against per 90 (2nd in Serie A)"
...
gabriel_desc <- "Gabriel is the busiest keeper in Serie A being forced to make a league high 91 saves (A save every 19.9 minutes).    4.24 GSAA % is the 3rd best in the league proving his worth by keeping an otherwise woeful Lecce team just above the relegation spots."
...
serieA_goalkeeping_MD20_plot <- serieA_gk %>% 
  ...
  geom_mark_hull(
    aes(filter = player == "W. Szczesny",
        label = "Wojciech Szczęsny (Juventus)",
  ...
  labs(title = "Goalkeeper Shot-Stopping & Workload: <b style='color: red'>Serie A (2019-2020)</b>",
       subtitle = glue::glue("
                             January 24th, 2020 | MD20 | Minimum 1080 Minutes Played
...
ggsave(plot = serieA_goalkeeping_MD20_plot, 
       here::here("Bundesliga 2019-2020/output/serieA_goalkeeping_1920_MD20.png"),
       height = 10, width = 14)
```

```{r}
plot_logo <- add_logo(
  plot_path = here::here("Bundesliga 2019-2020/output/serieA_goalkeeping_1920_MD20.png"),
...
image_write(image = plot_logo, 
            here::here("Bundesliga 2019-2020/output/serieA_goalkeeping_1920_MD20_logo.png"))
```
