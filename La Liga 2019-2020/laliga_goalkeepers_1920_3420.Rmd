...
laliga_goalkeeping_MD26_plot <- laliga_gk %>% 
  ...
  geom_mark_hull(
    ...
    label.width = unit(120, 'mm'), label.buffer = unit(1, "mm"),
    label.family = "Roboto Condensed", label.fontsize = c(14, 12),
    label.colour = "grey20", label.fill = "#cce5cc") +
  # Diego Lopez
  # geom_mark_hull(
  #   aes(filter = player == "D. López",
  #       label = "Diego López (Espanyol)",
  #       description = kepa_desc),
  #   expand = unit(2.5, "mm"), con.cap = unit(0, "mm"),
  #   con.colour = "orange", color = "orange",
  #   label.width = unit(160, 'mm'), label.buffer = unit(15, "mm"),
  #   label.family = "Roboto Condensed", label.fontsize = c(14, 12),
