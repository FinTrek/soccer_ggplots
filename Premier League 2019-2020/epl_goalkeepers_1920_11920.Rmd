...
```{r}
alisson_desc <- "Alisson proving to be the best keeper this season with his 9.96 GSAA %, 83.3 Save %, 0.41 Goals Against per 90 all leading the Premier League by a considerable margin."
...
gunn_desc <- "Angus Gunn was giving up a league-worst 2.5 Goals Against per 90 and -11.35 GSAA % before he was replaced after the horrendous 0-9 loss to Leicester City. His replacement Alex McCarthy has been doing much better with +6.6 GSAA % (3rd best in the league) and 1.31 Goals Against per 90!"
```
...
epl_goalkeeping_MD23_plot <- epl_gk %>% 
  ...
  geom_mark_hull(
    ...
    label.width = unit(110, 'mm'), label.buffer = unit(5, "mm"),
    label.family = "Roboto Condensed", label.fontsize = c(14, 12),
