...
Last season most of #Frontale's minutes were taken up by an aging core + rotating parts by a large # of players in their "peak" ages (a lot to cover for RB). In the offseason they've bought players like Issaka & Kamiya to provide more youthful backup. #川崎フロンターレ #JLeague

Nabbing Yamane will also help with solving the uncertainty around RB last season. While the likes to Mitoma, Hatate, & Miyadai will hope to gain some minutes to cover for the veteran Damiao & Kobayashi.
...
```{r}
plot_logo <- add_logo(plot_path = "../J-League 2020/output/kawasakifrontale_combplot.png",
                      logo_path = "https://upload.wikimedia.org/wikipedia/en/7/74/KawasakiFrontale.png",
                      logo_position = "top right",
                      logo_scale = 23)
...
```{r}
image_write(image = plot_logo, "../J-League 2020/output/kawasakifrontale_logo_combplot.png")
```
